...
namespace xtraForm.Model
{
    ...
    public partial class LiderAppEntities : DbContext
    {
        ...
        [DbFunction("LiderAppEntities", "ListadoPorRuta")]
        public virtual IQueryable<ListadoPorRuta_Result> ListadoPorRuta(string ruta, Nullable<System.DateTime> fecha, string gestion)
        {
            var rutaParameter = ruta != null ?
                new ObjectParameter("Ruta", ruta) :
                new ObjectParameter("Ruta", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ListadoPorRuta_Result>("[LiderAppEntities].[ListadoPorRuta](@Ruta, @Fecha, @Gestion)", rutaParameter, fechaParameter, gestionParameter);
        }
    
        public virtual ObjectResult<string> FacturarcionPorRutas1(string ruta, Nullable<System.DateTime> fecha, string gestion)
        {
            var rutaParameter = ruta != null ?
                new ObjectParameter("Ruta", ruta) :
                new ObjectParameter("Ruta", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("FacturarcionPorRutas1", rutaParameter, fechaParameter, gestionParameter);
        }
    
        [DbFunction("LiderAppEntities", "ListadoPorRuta1")]
        public virtual IQueryable<ListadoPorRuta1_Result> ListadoPorRuta1(string ruta, Nullable<System.DateTime> fecha, string gestion)
        {
            var rutaParameter = ruta != null ?
                new ObjectParameter("Ruta", ruta) :
                new ObjectParameter("Ruta", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ListadoPorRuta1_Result>("[LiderAppEntities].[ListadoPorRuta1](@Ruta, @Fecha, @Gestion)", rutaParameter, fechaParameter, gestionParameter);
        }
    
        [DbFunction("LiderAppEntities", "ListadoPorRuta_ClaseProducto")]
        public virtual IQueryable<ListadoPorRuta_ClaseProducto_Result1> ListadoPorRuta_ClaseProducto(string ruta, Nullable<System.DateTime> fecha, string gestion, string iDClase)
        {
            var rutaParameter = ruta != null ?
                new ObjectParameter("Ruta", ruta) :
                new ObjectParameter("Ruta", typeof(string));
            ...
            var iDClaseParameter = iDClase != null ?
                new ObjectParameter("IDClase", iDClase) :
                new ObjectParameter("IDClase", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ListadoPorRuta_ClaseProducto_Result1>("[LiderAppEntities].[ListadoPorRuta_ClaseProducto](@Ruta, @Fecha, @Gestion, @IDClase)", rutaParameter, fechaParameter, gestionParameter, iDClaseParameter);
        }
    }
}
